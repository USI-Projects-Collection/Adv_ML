...
Our experiment confirms that outlier tokens have higher accuracy on global class prediction, compared to normal tokens, across all 8 datasets that we tasted proving that they contains more global information (see table \ref{tab:global-probes}). 
